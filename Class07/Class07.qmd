...
To do this we used the `cutree()` function on our `hclust()` object:
...
To make one of main PCA result figures we turn to `pca$x` the scores along our new PCs. This is called "PC plot" or "score plot" or "oriendation plot"...
